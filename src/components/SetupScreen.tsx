...
const SetupScreen = ({
  ...
  return (
    <div className={`w-full mx-auto p-4 ${isMobile ? 'max-w-sm' : 'max-w-md'} bg-casino rounded-lg border border-casino-table shadow-lg`}>
      <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-center text-casino-gold">Card Table Blitz</h2>
          ...
          {Array.from({length: playerCount}).map((_, i) => (
            <div key={i}>
              ...
              <Input 
                ...
                className="bg-casino-dark border-casino-table" 
                maxLength={isMobile ? 8 : 10}
